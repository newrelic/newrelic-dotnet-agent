...
namespace NewRelic.Agent.Core.Transformers
{
	...
	public class CustomErrorDataTransformerTests
	{
		...
		public void Transform_FiltersAttributesBeforeSendingThemToErrorTraceMaker()
		{
			...
			// ACT
			var inputAttributes = new ReadOnlyDictionary<string, object>(new Dictionary<string, object>
			{
				{"key1", "value1"},
				{"key2", "value2"}
			});
			float priority = 0.5f;
			_customErrorDataTransformer.Transform(MakeError(inputAttributes), priority);
