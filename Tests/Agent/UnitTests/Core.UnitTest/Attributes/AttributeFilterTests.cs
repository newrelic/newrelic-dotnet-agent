	...
	""expected_destinations"":
	  [""transaction_events"", ""transaction_tracer"", ""error_collector"",""browser_monitoring""]
		...
		public void when(TestCase testCase)
		{
			...
			var attribute = new StringAttribute(testCase.AttributeKey, "foo", AttributeClassification.UserAttributes, testCase.AttributeDestinations.ToAttributeDestination());
