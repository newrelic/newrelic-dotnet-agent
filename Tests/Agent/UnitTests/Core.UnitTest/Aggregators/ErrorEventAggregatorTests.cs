...
namespace NewRelic.Agent.Core.Aggregators
{
	...
	public class ErrorEventAggregatorTests
	{
		...
		public void Events_send_on_harvest()
		{
			...
			{
				Mock.Create<ErrorEventWireModel>(_emptyAttributes, _intrinsicAttributes, _emptyAttributes, false, 0.3f),
				Mock.Create<ErrorEventWireModel>(_emptyAttributes, _intrinsicAttributes, _emptyAttributes, false, 0.2f),
				Mock.Create<ErrorEventWireModel>(_emptyAttributes, _intrinsicAttributes, _emptyAttributes, false, 0.1f)
			};
		...
		public void When_harvesting_events_then_event_sent_is_reported_to_agent_health()
		{
			...
			_errorEventAggregator.Collect(Mock.Create<ErrorEventWireModel>(_emptyAttributes, _intrinsicAttributes, _emptyAttributes, false, 0.1f));
			_errorEventAggregator.Collect(Mock.Create<ErrorEventWireModel>(_emptyAttributes, _intrinsicAttributes, _emptyAttributes, false, 0.2f));
			_errorEventAggregator.Collect(Mock.Create<ErrorEventWireModel>(_emptyAttributes, _intrinsicAttributes, _emptyAttributes, false, 0.3f));
		...
		public void When_more_than_reservoir_size_events_are_reported_number_events_seen_is_accurate()
		{
			...
			{
				_errorEventAggregator.Collect(Mock.Create<ErrorEventWireModel>(_emptyAttributes, _intrinsicAttributes, _emptyAttributes, false, i* 0.001f));
			}
