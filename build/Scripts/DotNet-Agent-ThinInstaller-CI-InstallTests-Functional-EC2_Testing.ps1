...
Function RunFunctionalTests
{
    ...
    Write-Host "nunit3-console.exe `"$env:WORKSPACE\FunctionalTests\bin\Release\net45\FunctionalTests.dll`" --where `"cat==ThinInstall`" --workers=1 `"--result=TestResult_NUnit2.xml;format=nunit2`" `"--result=TestResult_NUnit3.xml;format=nunit3`""
