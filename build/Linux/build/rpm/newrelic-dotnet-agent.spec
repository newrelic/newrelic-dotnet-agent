...
rm -f $NEWRELIC_HOME/extensions/NewRelic.Providers.Wrapper.Asp35.Instrumentation.xml 2> /dev/null
rm -f $NEWRELIC_HOME/extensions/NewRelic.Providers.Wrapper.Asp35.dll 2> /dev/null
