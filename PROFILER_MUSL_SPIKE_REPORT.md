...
- `DllGetClassObject` ✓
- `DllCanUnloadNow` ✓
- All inspected `sicily::ast::*Type::*` constructors and assignment operators ✓
...
Critical COM entry points present: `DllGetClassObject` ✓, `DllCanUnloadNow` ✓.
