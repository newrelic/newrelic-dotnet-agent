...
namespace ArtifactBuilder.Artifacts
{
	...
	{
		public NugetAgentExtensions(string configuration, string sourceDirectory)
			: base(sourceDirectory, nameof(NugetAgentExtensions))
		{
			Configuration = configuration;
			NugetPackagePath = $@"{sourceDirectory}\Agent\NewRelic\Agent\Extensions\NewRelic.Agent.Extensions\bin\{configuration}";
		}
