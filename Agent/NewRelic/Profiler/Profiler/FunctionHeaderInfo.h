...
namespace NewRelic {
	namespace Profiler {
		...
		public:
			...
			// TODO(rrh): Dispatch instead on the controlFlow field
			// TODO(rrh): aren't handling 2-byte endfilter RETURN-style instruction.
			virtual NewRelic::Profiler::MethodRewriter::InstructionTypeCounts GetInstructionTypeCounts() override
			{
				...
				for (unsigned pos = 0; pos < size; /*VOID*/) {
					...
					// TODO(rrh): Dispatch instead on the controlFlow field
					// TODO(rrh): Pick up 2-byte endfilter return instruction?
