...
namespace NewRelic.Agent.Extensions.Providers.Wrapper
{
	...
	public interface IAgentWrapperApi
	{
		...
		/// 
		/// <returns></returns>
		ITransactionWrapperApi CreateTransaction(bool isWeb, string category, string transactionDisplayName, bool mustBeRootTransaction);
		...
		ITransactionWrapperApi CreateWebTransaction(WebTransactionType type, string name, bool mustBeRootTransaction = true, Action onCreate = null);
		...
		/// <exception cref="System.ArgumentNullException"></exception>
		[Obsolete("Use the CreateTransaction() overrides instead")]
		ITransactionWrapperApi CreateMessageBrokerTransaction(MessageBrokerDestinationType destinationType, string brokerVendorName, string destination = null, Action onCreate = null);
		...
		/// <exception cref="System.ArgumentNullException"></exception>
		[Obsolete("Use the CreateTransaction() overrides instead")]
		ITransactionWrapperApi CreateOtherTransaction(string category, string name, bool mustBeRootTransaction = true, Action onCreate = null);
