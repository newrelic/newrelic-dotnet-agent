...
namespace NewRelic.Agent.Core.Segments
{
	...
	public interface ISpanEventWireModel : IHasPriority
	{
	...
	public class SpanAttributeValueCollection : AttributeValueCollection<AttributeValue>, ISpanEventWireModel
	{
