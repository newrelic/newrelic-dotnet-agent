...
namespace NewRelic.Agent.Core.Attributes
{
	...
	public interface IAttributeDefinitions
	{
		...
		AttributeDefinition<string, string> CatAlternativePathHashes { get; }
		...
		AttributeDefinition<float, double> DatabaseCallCount { get; }
		...
		AttributeDefinition<string, string> ParentTransportType { get; }
		...
		AttributeDefinition<string, string> ResponseStatus { get; }
		...
		AttributeDefinition<TypeAttributeValue, string> Type { get; }
	...
	public class AttributeDefinitions : IAttributeDefinitions
	{
		...
		public AttributeDefinition<TimeSpan, string> QueueWaitTime => _queueWaitTime ?? (_queueWaitTime =
			AttributeDefinitionBuilder.CreateString<TimeSpan>("queue_wait_time_ms", AttributeClassification.AgentAttributes)
				...
				.WithConvert((v) => v.TotalMilliseconds.ToString(CultureInfo.InvariantCulture))
				.Build(_attribFilter));
		...
		private AttributeDefinition<string, string> _responseStatus;
		public AttributeDefinition<string, string> ResponseStatus => _responseStatus ?? (_responseStatus =
			AttributeDefinitionBuilder.CreateString("response.status", AttributeClassification.AgentAttributes)
				.AppliesTo(AttributeDestinations.ErrorEvent)
				.AppliesTo(AttributeDestinations.ErrorTrace)
				.AppliesTo(AttributeDestinations.TransactionEvent)
				.AppliesTo(AttributeDestinations.ErrorEvent)
		...
		private AttributeDefinition<string, string> _catAlternativePathHashes;
		public AttributeDefinition<string, string> CatAlternativePathHashes => _catAlternativePathHashes ?? (_catAlternativePathHashes =
			AttributeDefinitionBuilder.CreateString("nr.alternatePathHashes", AttributeClassification.Intrinsics)
				.AppliesTo(AttributeDestinations.TransactionEvent)
				.Build(_attribFilter));
		...
		private AttributeDefinition<float, double> _databaseCallCount;
		public AttributeDefinition<float, double> DatabaseCallCount => _databaseCallCount ?? (_databaseCallCount =
			AttributeDefinitionBuilder.CreateDouble<float>("databaseCallCount", AttributeClassification.Intrinsics)
				.AppliesTo(AttributeDestinations.TransactionEvent)
				.AppliesTo(AttributeDestinations.ErrorEvent)
				.WithConvert(x => x)
				.Build(_attribFilter));
		...
		private AttributeDefinition<string, string> _parentTransportType;
		public AttributeDefinition<string, string> ParentTransportType => _parentTransportType ?? (_parentTransportType =
			AttributeDefinitionBuilder.CreateString("parent.transportType", AttributeClassification.Intrinsics)
				.AppliesTo(AttributeDestinations.TransactionTrace)
				.AppliesTo(AttributeDestinations.ErrorTrace)
				.AppliesTo(AttributeDestinations.SqlTrace)
				.AppliesTo(AttributeDestinations.TransactionEvent)
		...
		//TODO:  This should be using the type Enum				
