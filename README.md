...
#### .NET Agent
New Relic's .NET agent monitors your .NET applications, giving you an end-to-end view of your app's performance. It works with all .NET compatible languages, such as C#, VB.NET and CLI.
