...
| AWSSDK.SQS | [AWSSDK.SQS](https://www.nuget.org/packages/AWSSDK.SQS/) | 3.7.0 – 4.0.2.33 | 10.27.0 | <ul><li>Message send and receive.</li></ul> |
| AWSSDK.Kinesis | [AWSSDK.Kinesis](https://www.nuget.org/packages/AWSSDK.Kinesis/) | 3.7.0 – 4.0.8.19 | 10.40.0 | <ul><li>`PutRecord(s)Async` and `GetRecordsAsync` are instrumented as message broker operations; other operations as basic method calls.</li></ul> |
| AWSSDK.KinesisFirehose | [AWSSDK.KinesisFirehose](https://www.nuget.org/packages/AWSSDK.KinesisFirehose/) | 3.7.0 – 4.0.3.32 | 10.40.0 | <ul><li>All Kinesis Firehose operations are instrumented as basic method calls.</li></ul> |
