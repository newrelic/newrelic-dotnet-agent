...
| --- | --- | --- | --- | --- |
| Cosmos DB | [Microsoft.Azure.Cosmos](https://www.nuget.org/packages/Microsoft.Azure.Cosmos/) | 3.17.0 – 3.63.0 | 9.2.0 | <ul><li>Versions 3.35.0+ supported since agent v10.32.0.</li></ul> |
...
| Microsoft SQL Server | [Microsoft.Data.SqlClient](https://www.nuget.org/packages/Microsoft.Data.SqlClient/) | 1.0.19239.1 – 7.0.3 | — |  |
| System.Data.ODBC | [System.Data.Odbc](https://www.nuget.org/packages/System.Data.Odbc/) | 8.0.0 – 10.0.12 | 10.36.0 | <ul><li>On .NET 8+, the following ODBC operations are not instrumented (they are instrumented on .NET Framework via the built-in System.Data namespace): Connection `Open`/`OpenAsync` calls, SqlDataReader `Read`/`NextResult` calls, and slow SQL traces.</li></ul> |
| MongoDB (modern driver) | [MongoDB.Driver](https://www.nuget.org/packages/MongoDB.Driver/) | 2.3.0 – 3.11.2 | — | <ul><li>Versions 3.0.0+ supported since agent v10.40.0.</li><li>Beginning in agent version 10.12.0, the following methods added in or after driver version 2.7 are instrumented: <br>`IMongoCollection.CountDocuments[Async]` <br>`IMongoCollection.EstimatedDocumentCount[Async]` <br>`IMongoCollection.AggregateToCollection[Async]` <br>`IMongoDatabase.ListCollectionNames[Async]` <br>`IMongoDatabase.Aggregate[Async]` <br>`IMongoDatabase.AggregateToCollection[Async]` <br>`IMongoDatabase.Watch[Async]`.</li></ul> |
| MySQL | [MySql.Data](https://www.nuget.org/packages/MySql.Data/) | 6.10.7 – 26.7.0 | — | <ul><li>Versions 9.7.0+ supported since agent v10.51.1.</li></ul> |
| MySQL | [MySqlConnector](https://www.nuget.org/packages/MySqlConnector/) | 1.0.1 – 2.6.2 | — |  |
| Oracle | [Oracle.ManagedDataAccess.Core](https://www.nuget.org/packages/Oracle.ManagedDataAccess.Core/) | 23.4.0 – 23.26.301 | — | <ul><li>Older versions may be instrumented but are not tested or supported.</li></ul> |
...
| StackExchange.Redis | [StackExchange.Redis](https://www.nuget.org/packages/StackExchange.Redis/) | 1.0.488 – 3.2.1 | — | <ul><li>The strong-named `StackExchange.Redis.StrongName` package is also instrumented.</li></ul> |
...
| OpenSearch | [OpenSearch.Client](https://www.nuget.org/packages/OpenSearch.Client/) | 1.0.0 – 2.1.0 | 10.36.0 |  |
| Memcached | [EnyimMemcachedCore](https://www.nuget.org/packages/EnyimMemcachedCore/) | 2.0.0 – 3.5.1 | — |  |
| DynamoDB | [AWSSDK.DynamoDBv2](https://www.nuget.org/packages/AWSSDK.DynamoDBv2/) | 3.5.0 – 4.0.103.8 | 10.33.0 |  |
...
| Library | NuGet package | Supported versions | Min agent version | Notes |
| --- | --- | --- | --- | --- |
| AWS Bedrock | [AWSSDK.BedrockRuntime](https://www.nuget.org/packages/AWSSDK.BedrockRuntime/) | 3.7.200.0 – 4.0.101.7 | 10.23.0 | <ul><li>`ConverseAsync` instrumented since agent v10.37.0.</li></ul><details><summary>Instrumented methods (2)</summary><ul><li><code>InvokeModelAsync</code></li><li><code>ConverseAsync</code></li></ul></details> |
...
| Library | NuGet package | Supported versions | Min agent version | Notes |
| --- | --- | --- | --- | --- |
| Log4Net | [log4net](https://www.nuget.org/packages/log4net/) | 2.0.10 – 3.4.0 | 9.7.0 |  |
| Serilog | [Serilog](https://www.nuget.org/packages/Serilog/) | 2.5.0 – 4.4.0 | 9.7.0 |  |
| NLog | [NLog](https://www.nuget.org/packages/NLog/) | 4.5.0 – 6.2.0 | 9.7.0 |  |
| Microsoft.Extensions.Logging | [Microsoft.Extensions.Logging](https://www.nuget.org/packages/Microsoft.Extensions.Logging/) | 3.0.0 – 10.0.12 | 10.0.0 |  |
...
| Library | NuGet package | Supported versions | Min agent version | Notes |
| --- | --- | --- | --- | --- |
| Confluent.Kafka | [Confluent.Kafka](https://www.nuget.org/packages/Confluent.Kafka/) | 1.4.0 – 2.15.1 | — | <details><summary>Instrumented methods (3)</summary><ul><li><code>IProducer.Produce</code></li><li><code>IProducer.ProduceAsync</code></li><li><code>IConsumer.Consume</code></li></ul></details> |
| NServiceBus | [NServiceBus](https://www.nuget.org/packages/NServiceBus/) | 5.0 – 10.2.9 | — | <ul><li>Puts and takes on messages.</li></ul> |
...
| AWSSDK.SQS | [AWSSDK.SQS](https://www.nuget.org/packages/AWSSDK.SQS/) | 3.7.0 – 4.0.100.14 | 10.27.0 | <ul><li>Message send and receive.</li></ul> |
| AWSSDK.Kinesis | [AWSSDK.Kinesis](https://www.nuget.org/packages/AWSSDK.Kinesis/) | 3.7.0 – 4.0.103.3 | 10.40.0 | <ul><li>`PutRecord(s)Async` and `GetRecordsAsync` are instrumented as message broker operations; other operations as basic method calls.</li></ul> |
| AWSSDK.KinesisFirehose | [AWSSDK.KinesisFirehose](https://www.nuget.org/packages/AWSSDK.KinesisFirehose/) | 3.7.0 – 4.0.100.14 | 10.40.0 | <ul><li>All Kinesis Firehose operations are instrumented as basic method calls.</li></ul> |
...
| Library | NuGet package | Supported versions | Min agent version | Notes |
| --- | --- | --- | --- | --- |
| Hangfire | [Hangfire](https://www.nuget.org/packages/Hangfire/) | 1.7.0 – 1.8.25 | 10.51.0 |  |
...
| System.Data.ODBC | [System.Data.Odbc](https://www.nuget.org/packages/System.Data.Odbc/) | 8.0.0 – 10.0.12 | 10.36.0 |  |
...
| MySQL | [MySql.Data](https://www.nuget.org/packages/MySql.Data/) | 6.10.7 – 26.7.0 | — | <ul><li>Versions 9.7.0+ supported since agent v10.51.1.</li></ul> |
| MySQL | [MySqlConnector](https://www.nuget.org/packages/MySqlConnector/) | 1.0.1 – 2.6.2 | — |  |
| Oracle | [Oracle.ManagedDataAccess](https://www.nuget.org/packages/Oracle.ManagedDataAccess/) | 12.1.2400 – 23.26.301 | — |  |
...
| HttpWebRequest | — | — | — | <ul><li>`BeginGetResponse`, `EndGetResponse`, `GetRequestStream`, `BeginGetRequestStream`, and `GetRequestStreamAsync` are supported in agent v10.52.0 and later. `GetResponse` is supported in all agent versions.</li></ul><details><summary>Instrumented methods (6)</summary><ul><li><code>GetResponse</code></li><li><code>BeginGetResponse</code></li><li><code>EndGetResponse</code></li><li><code>GetRequestStream</code></li><li><code>BeginGetRequestStream</code></li><li><code>GetRequestStreamAsync</code></li></ul></details> |
| AWSSDK.Lambda | [AWSSDK.Lambda](https://www.nuget.org/packages/AWSSDK.Lambda/) | 3.7.0 – 4.0.0.1 | 10.35.0 | <ul><li>Instruments invoking a Lambda function from the AWS SDK. To monitor a function running as an AWS Lambda, see [AWS Lambda monitoring](https://docs.newrelic.com/docs/serverless-function-monitoring/aws-lambda-monitoring/get-started/monitoring-aws-lambda-serverless-monitoring/).</li></ul> |
...
| Library | NuGet package | Supported versions | Min agent version | Notes |
| --- | --- | --- | --- | --- |
| Log4Net | [log4net](https://www.nuget.org/packages/log4net/) | 1.2.10 – 3.4.0 | 9.7.0 |  |
...
| NLog | [NLog](https://www.nuget.org/packages/NLog/) | 4.1.0 – 6.2.0 | 9.7.0 |  |
| Microsoft.Extensions.Logging | [Microsoft.Extensions.Logging](https://www.nuget.org/packages/Microsoft.Extensions.Logging/) | 3.0.0 – 10.0.12 | 9.7.0 |  |
