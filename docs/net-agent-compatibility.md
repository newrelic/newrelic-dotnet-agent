...
| --- | --- | --- | --- | --- |
| Cosmos DB | [Microsoft.Azure.Cosmos](https://www.nuget.org/packages/Microsoft.Azure.Cosmos/) | 3.17.0 – 3.62.1 | 9.2.0 | <ul><li>Versions 3.35.0+ supported since agent v10.32.0.</li></ul> |
...
| Oracle | [Oracle.ManagedDataAccess.Core](https://www.nuget.org/packages/Oracle.ManagedDataAccess.Core/) | 23.4.0 – 23.26.300 | — | <ul><li>Older versions may be instrumented but are not tested or supported.</li></ul> |
...
| StackExchange.Redis | [StackExchange.Redis](https://www.nuget.org/packages/StackExchange.Redis/) | 1.0.488 – 3.1.31 | — | <ul><li>The strong-named `StackExchange.Redis.StrongName` package is also instrumented.</li></ul> |
...
| DynamoDB | [AWSSDK.DynamoDBv2](https://www.nuget.org/packages/AWSSDK.DynamoDBv2/) | 3.5.0 – 4.0.103.5 | 10.33.0 |  |
...
| Library | NuGet package | Supported versions | Min agent version | Notes |
| --- | --- | --- | --- | --- |
| AWS Bedrock | [AWSSDK.BedrockRuntime](https://www.nuget.org/packages/AWSSDK.BedrockRuntime/) | 3.7.200.0 – 4.0.101.4 | 10.23.0 | <ul><li>`ConverseAsync` instrumented since agent v10.37.0.</li></ul><details><summary>Instrumented methods (2)</summary><ul><li><code>InvokeModelAsync</code></li><li><code>ConverseAsync</code></li></ul></details> |
...
| Microsoft.Extensions.Logging | [Microsoft.Extensions.Logging](https://www.nuget.org/packages/Microsoft.Extensions.Logging/) | 3.0.0 – 10.0.11 | 10.0.0 |  |
...
| Library | NuGet package | Supported versions | Min agent version | Notes |
| --- | --- | --- | --- | --- |
| Confluent.Kafka | [Confluent.Kafka](https://www.nuget.org/packages/Confluent.Kafka/) | 1.4.0 – 2.15.0 | — | <details><summary>Instrumented methods (3)</summary><ul><li><code>IProducer.Produce</code></li><li><code>IProducer.ProduceAsync</code></li><li><code>IConsumer.Consume</code></li></ul></details> |
| NServiceBus | [NServiceBus](https://www.nuget.org/packages/NServiceBus/) | 5.0 – 10.2.8 | — | <ul><li>Puts and takes on messages.</li></ul> |
...
| AWSSDK.SQS | [AWSSDK.SQS](https://www.nuget.org/packages/AWSSDK.SQS/) | 3.7.0 – 4.0.100.11 | 10.27.0 | <ul><li>Message send and receive.</li></ul> |
| AWSSDK.Kinesis | [AWSSDK.Kinesis](https://www.nuget.org/packages/AWSSDK.Kinesis/) | 3.7.0 – 4.0.102 | 10.40.0 | <ul><li>`PutRecord(s)Async` and `GetRecordsAsync` are instrumented as message broker operations; other operations as basic method calls.</li></ul> |
| AWSSDK.KinesisFirehose | [AWSSDK.KinesisFirehose](https://www.nuget.org/packages/AWSSDK.KinesisFirehose/) | 3.7.0 – 4.0.100.11 | 10.40.0 | <ul><li>All Kinesis Firehose operations are instrumented as basic method calls.</li></ul> |
...
| System.Data.ODBC | [System.Data.Odbc](https://www.nuget.org/packages/System.Data.Odbc/) | 8.0.0 – 10.0.11 | 10.36.0 |  |
...
| MySQL | [MySql.Data](https://www.nuget.org/packages/MySql.Data/) | 6.10.7 – 26.7.0 | — | <ul><li>Versions 9.7.0+ supported since agent v10.51.1.</li></ul> |
| MySQL | [MySqlConnector](https://www.nuget.org/packages/MySqlConnector/) | 1.0.1 – 2.6.2 | — |  |
| Oracle | [Oracle.ManagedDataAccess](https://www.nuget.org/packages/Oracle.ManagedDataAccess/) | 12.1.2400 – 23.26.300 | — |  |
...
| Microsoft.Extensions.Logging | [Microsoft.Extensions.Logging](https://www.nuget.org/packages/Microsoft.Extensions.Logging/) | 3.0.0 – 10.0.11 | 9.7.0 |  |
