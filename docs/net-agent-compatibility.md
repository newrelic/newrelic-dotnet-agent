...
| --- | --- | --- | --- | --- |
| Cosmos DB | [Microsoft.Azure.Cosmos](https://www.nuget.org/packages/Microsoft.Azure.Cosmos/) | 3.17.0 – 3.62.0 | 9.2.0 | <ul><li>Versions 3.35.0+ supported since agent v10.32.0.</li></ul> |
...
| MySQL | [MySqlConnector](https://www.nuget.org/packages/MySqlConnector/) | 1.0.1 – 2.6.1 | — |  |
...
| StackExchange.Redis | [StackExchange.Redis](https://www.nuget.org/packages/StackExchange.Redis/) | 1.0.488 – 3.1.0 | — | <ul><li>The strong-named `StackExchange.Redis.StrongName` package is also instrumented.</li></ul> |
...
| DynamoDB | [AWSSDK.DynamoDBv2](https://www.nuget.org/packages/AWSSDK.DynamoDBv2/) | 3.5.0 – 4.0.102.1 | 10.33.0 |  |
...
| Library | NuGet package | Supported versions | Min agent version | Notes |
| --- | --- | --- | --- | --- |
| AWS Bedrock | [AWSSDK.BedrockRuntime](https://www.nuget.org/packages/AWSSDK.BedrockRuntime/) | 3.7.200.0 – 4.0.101 | 10.23.0 | <ul><li>`ConverseAsync` instrumented since agent v10.37.0.</li></ul><details><summary>Instrumented methods (2)</summary><ul><li><code>InvokeModelAsync</code></li><li><code>ConverseAsync</code></li></ul></details> |
...
| NServiceBus | [NServiceBus](https://www.nuget.org/packages/NServiceBus/) | 5.0 – 10.2.7 | — | <ul><li>Puts and takes on messages.</li></ul> |
...
| AWSSDK.SQS | [AWSSDK.SQS](https://www.nuget.org/packages/AWSSDK.SQS/) | 3.7.0 – 4.0.100.7 | 10.27.0 | <ul><li>Message send and receive.</li></ul> |
| AWSSDK.Kinesis | [AWSSDK.Kinesis](https://www.nuget.org/packages/AWSSDK.Kinesis/) | 3.7.0 – 4.0.100.7 | 10.40.0 | <ul><li>`PutRecord(s)Async` and `GetRecordsAsync` are instrumented as message broker operations; other operations as basic method calls.</li></ul> |
| AWSSDK.KinesisFirehose | [AWSSDK.KinesisFirehose](https://www.nuget.org/packages/AWSSDK.KinesisFirehose/) | 3.7.0 – 4.0.100.7 | 10.40.0 | <ul><li>All Kinesis Firehose operations are instrumented as basic method calls.</li></ul> |
...
| System.Data.ODBC | [System.Data.Odbc](https://www.nuget.org/packages/System.Data.Odbc/) | 8.0.0 – 10.0.10 | 10.36.0 |  |
