...
public class Bar : IInterface {}"),
		...
		{
			var result = TypeInstantiator.ExportedInstancesFromDirectory<IInterface>("C:\\Foo\\Bar");
			Assert.AreEqual(0, result.Instances.Count());
			Assert.AreEqual(0, result.Exceptions.Count());
		}
		...
		{
			var result = TypeInstantiator.ExportedInstancesFromDirectory<IInterface>("!@#$%");
			Assert.AreEqual(0, result.Instances.Count());
			Assert.AreEqual(0, result.Exceptions.Count());
		}
		...
		{
			var result = TypeInstantiator.ExportedInstancesFromDirectory<IInterface>(null);
			Assert.AreEqual(0, result.Instances.Count());
			Assert.AreEqual(0, result.Exceptions.Count());
		}
