...
[TestFixture]
public class HybridAgentLlmTests : HybridAgentTestsBase
{
    public HybridAgentLlmTests() : base()
    {
        _enableAiMonitoring = true;
    }

    [TestCaseSource(nameof(GetHybridAgentLlmTestData))]
    ...
    private static List<TestCaseData> GetHybridAgentLlmTestData()
    {
        ...
        var jsonPath = Path.Combine(dllPath, "HybridAgent", "TestCaseDefinitions", "HybridAgentLlmTests.json");
        ...
        foreach (var testData in testList)
        {
            ...
            testCase.SetName("HybridAgent_LlmTests: " + testData.TestDescription);
