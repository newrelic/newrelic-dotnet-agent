...
public class AgentHealthReporterTests
{
    ...
    [Test]
    public void ReportCustomInstrumentation_ReportsExpectedMetrics()
    {
        // Act
        _agentHealthReporter.ReportCustomInstrumentation("AssemblyName", "ClassName", "MethodName");

        _agentHealthReporter.CollectMetrics();

        var expectedMetricNamesAndValues = new Dictionary<string, long>
        {
            { "Supportability/CustomInst/Count", 1 },
            { "Supportability/CustomInst/AssemblyName/ClassName/MethodName", 1 }
        };
        var actualMetricNamesAndValues = _publishedMetrics.Select(x => new KeyValuePair<string, long>(x.MetricNameModel.Name, x.DataModel.Value0));
    ...
    [Test]
    public void ReportCustomInstrumentation_ReportsExpectedMetrics_WhenCalledWithSameParameters()
    {
        // Act
        _agentHealthReporter.ReportCustomInstrumentation("AssemblyName", "ClassName", "MethodName");
        _agentHealthReporter.ReportCustomInstrumentation("AssemblyName", "ClassName", "MethodName");
    ...
    [Test]
    public void ReportCustomInstrumentation_ReportsExpectedMetrics_WhenCalledWithDifferentParameters()
    {
        // Act
        _agentHealthReporter.ReportCustomInstrumentation("AssemblyName1", "ClassName1", "MethodName1");
        _agentHealthReporter.ReportCustomInstrumentation("AssemblyName2", "ClassName2", "MethodName2");

        _agentHealthReporter.CollectMetrics();

        var expectedMetricNamesAndValues = new Dictionary<string, long>
        {
            { "Supportability/CustomInst/Count", 2 },
            { "Supportability/CustomInst/AssemblyName1/ClassName1/MethodName1", 1 },
            { "Supportability/CustomInst/AssemblyName2/ClassName2/MethodName2", 1 }
        };
        var actualMetricNamesAndValues = _publishedMetrics.Select(x => new KeyValuePair<string, long>(x.MetricNameModel.Name, x.DataModel.Value0));
        Assert.That(expectedMetricNamesAndValues, Is.SubsetOf(actualMetricNamesAndValues));
    }
    ...
    [Test]
    public void ReportCustomInstrumentation_RespectsConfiguredMaximum()
    {
        var configuration = GetDefaultConfiguration();
        Mock.Arrange(() => configuration.MaxCustomInstrumentationSupportabilityMetrics).Returns(2);
        ...
        _agentHealthReporter.ReportCustomInstrumentation("AssemblyName1", "ClassName1", "MethodName1");
        _agentHealthReporter.ReportCustomInstrumentation("AssemblyName2", "ClassName2", "MethodName2");
        _agentHealthReporter.ReportCustomInstrumentation("AssemblyName3", "ClassName3", "MethodName3");
        ...
        var expectedMetricNamesAndValues = new Dictionary<string, long>
        {
            // count is always reported but individual metrics are capped
            { "Supportability/CustomInst/Count", 3 },
            { "Supportability/CustomInst/AssemblyName1/ClassName1/MethodName1", 1 },
            { "Supportability/CustomInst/AssemblyName2/ClassName2/MethodName2", 1 },
        };
