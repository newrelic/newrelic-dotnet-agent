...
namespace NewRelic.Agent.Core.Aggregators
{
    ...
    public class LogEventAggregatorTests
    {
        ...
        public void Events_send_on_harvest()
        {
            ...
            // Assert
            ClassicAssert.AreEqual(3, sentEvents.LoggingEvents.Count());
            ClassicAssert.AreEqual(sentEvents.LoggingEvents, logEvents);
        }
        ...
        public void When_more_than_reservoir_size_events_are_reported_number_events_seen_is_accurate()
        {
            ...
            ClassicAssert.AreEqual(expectedAddAttempts, actualAddAttempts);
        }
        ...
        public void When_harvest_occurs_default_reservoir_size_is_reported_accurately()
        {
            ...
            ClassicAssert.AreEqual(expectedReservoirSize, actualReservoirSize);
        }
