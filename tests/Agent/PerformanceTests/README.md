...
|---|---|---|
| **PerformanceTestApp** | ASP.NET Core (.NET 10) | Synthetic workload server — endpoints exercising simple JSON, nested async, MongoDB CRUD, SQLite CRUD, RabbitMQ publish/consume, and health; uses Serilog for structured log forwarding |
