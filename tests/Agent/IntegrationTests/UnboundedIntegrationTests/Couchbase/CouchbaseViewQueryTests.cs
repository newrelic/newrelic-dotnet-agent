    ...
    public class CouchbaseViewQueryTests : NewRelicIntegrationTest<RemoteServiceFixtures.CouchbaseBasicMvcFixture>
    {
        ...
        public void Test()
        {
            var expectedMetrics = new List<Assertions.ExpectedMetric>
            {
                ...
                new Assertions.ExpectedMetric { metricName = $"Datastore/statement/Couchbase/{CouchbaseTestObject.CouchbaseTestBucket}/Query", callCount = 1, metricScope = "WebTransaction/MVC/CouchbaseController/Couchbase_ViewQuery" },
            ...
            var unexpectedMetrics = new List<Assertions.ExpectedMetric>
            {
				...
				new Assertions.ExpectedMetric { metricName = "Datastore/operation/Couchbase/Query", callCount = 1, metricScope = "WebTransaction/MVC/CouchbaseController/Couchbase_ViewQuery" },
            };
            ...
            var transactionSample = _fixture.AgentLog.TryGetTransactionSample("WebTransaction/MVC/CouchbaseController/Couchbase_ViewQuery");
            var transactionEvent = _fixture.AgentLog.TryGetTransactionEvent("WebTransaction/MVC/CouchbaseController/Couchbase_ViewQuery");
