    ...
    public class CouchbaseQueryRequestTests : NewRelicIntegrationTest<RemoteServiceFixtures.CouchbaseBasicMvcFixture>
    {
        ...
        public CouchbaseQueryRequestTests(RemoteServiceFixtures.CouchbaseBasicMvcFixture fixture, ITestOutputHelper output)  : base(fixture)
        {
            ...
            (
                ...
                exerciseApplication: () =>
                {
                    _fixture.Couchbase_QueryRequest();
                }
            );
        ...
        public void Test()
        {
            var expectedMetrics = new List<Assertions.ExpectedMetric>
            {
                ...
                new Assertions.ExpectedMetric { metricName = $"Datastore/statement/Couchbase/{CouchbaseTestObject.CouchbaseTestBucket}/Query", callCount = 1, metricScope = "WebTransaction/MVC/CouchbaseController/Couchbase_QueryRequest" },
            ...
            var unexpectedMetrics = new List<Assertions.ExpectedMetric>
            {
				...
				new Assertions.ExpectedMetric { metricName = "Datastore/operation/Couchbase/Query", callCount = 1, metricScope = "WebTransaction/MVC/CouchbaseController/Couchbase_QueryRequest" },
            };
            ...
            var expectedSqlTraces = new List<Assertions.ExpectedSqlTrace>
            {
                ...
                {
                    TransactionName = "WebTransaction/MVC/CouchbaseController/Couchbase_QueryRequest",
            ...
            var transactionSample = _fixture.AgentLog.TryGetTransactionSample("WebTransaction/MVC/CouchbaseController/Couchbase_QueryRequest");
            var transactionEvent = _fixture.AgentLog.TryGetTransactionEvent("WebTransaction/MVC/CouchbaseController/Couchbase_QueryRequest");
