...
namespace NewRelic.Agent.UnboundedIntegrationTests.Couchbase
{
    public class CouchbaseAsyncQueryTests : IClassFixture<RemoteServiceFixtures.CouchbaseBasicMvcFixture>
    {
        ...
        public CouchbaseAsyncQueryTests([NotNull] RemoteServiceFixtures.CouchbaseBasicMvcFixture fixture, [NotNull] ITestOutputHelper output)
        {
            _fixture = fixture;
        ...
        public void Test()
        {
            var expectedMetrics = new List<Assertions.ExpectedMetric>
            {
                ...
                new Assertions.ExpectedMetric { metricName = $"Datastore/statement/Couchbase/{CouchbaseTestObject.CouchbaseTestBucket}/QueryAsync", callCount = 1, metricScope = "WebTransaction/MVC/CouchbaseController/Couchbase_QueryAsync" },
            ...
            var unexpectedMetrics = new List<Assertions.ExpectedMetric>
            {
                ...
                new Assertions.ExpectedMetric { metricName = "Datastore/operation/Couchbase/QueryAsync", callCount = 1, metricScope = "WebTransaction/MVC/CouchbaseController/Couchbase_QueryAsync" },
            };
            ...
            var expectedSqlTraces = new List<Assertions.ExpectedSqlTrace>
            {
                ...
                {
                    TransactionName = "WebTransaction/MVC/CouchbaseController/Couchbase_QueryAsync",
            ...
            var transactionSample = _fixture.AgentLog.TryGetTransactionSample("WebTransaction/MVC/CouchbaseController/Couchbase_QueryAsync");
            var transactionEvent = _fixture.AgentLog.TryGetTransactionEvent("WebTransaction/MVC/CouchbaseController/Couchbase_QueryAsync");
