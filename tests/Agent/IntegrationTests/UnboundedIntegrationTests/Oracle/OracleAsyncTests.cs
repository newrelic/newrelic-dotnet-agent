    ...
    where TFixture : ConsoleDynamicMethodFixture
{
    ...
    public void Test()
    {
        ...
        var expectedMetrics = new List<Assertions.ExpectedMetric>
        {
            ...
            new() { metricName = @"Datastore/statement/Oracle/user_tables/select", CallCountAllHarvests = 1, metricScope = "OtherTransaction/Custom/MultiFunctionApplicationHelpers.NetStandardLibraries.Oracle.OracleExerciser/ExerciseAsync"},
            new() { metricName = $@"Datastore/statement/Oracle/{_tableName}/select", CallCountAllHarvests = 1 },
            new() { metricName = $@"Datastore/statement/Oracle/{_tableName}/select", CallCountAllHarvests = 1, metricScope = "OtherTransaction/Custom/MultiFunctionApplicationHelpers.NetStandardLibraries.Oracle.OracleExerciser/ExerciseAsync"},
            ...
            new() { metricName = $@"Datastore/statement/Oracle/{_tableName}/insert", CallCountAllHarvests = 1, metricScope = "OtherTransaction/Custom/MultiFunctionApplicationHelpers.NetStandardLibraries.Oracle.OracleExerciser/ExerciseAsync"},
            ...
            new() { metricName = $@"Datastore/statement/Oracle/{_tableName}/delete", CallCountAllHarvests = 1, metricScope = "OtherTransaction/Custom/MultiFunctionApplicationHelpers.NetStandardLibraries.Oracle.OracleExerciser/ExerciseAsync"},

            new() { metricName = @"DotNet/DatabaseResult/Iterate" , CallCountAllHarvests = expectedIterateCallCount },
            new() { metricName = @"DotNet/DatabaseResult/Iterate", CallCountAllHarvests = expectedIterateCallCount, metricScope = "OtherTransaction/Custom/MultiFunctionApplicationHelpers.NetStandardLibraries.Oracle.OracleExerciser/ExerciseAsync"}
        };
