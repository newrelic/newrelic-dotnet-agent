...
{
    public class PostgresAsyncTests : IClassFixture<RemoteServiceFixtures.BasicMvcApplication>
    {
        [NotNull]
        private readonly RemoteServiceFixtures.BasicMvcApplication _fixture;

        public PostgresAsyncTests([NotNull] RemoteServiceFixtures.BasicMvcApplication fixture, [NotNull] ITestOutputHelper output)
        {
            _fixture = fixture;
        ...
        public void Test()
        {
            var expectedMetrics = new List<Assertions.ExpectedMetric>
            {
				...
				// We don't currently have instrumentation for PostgresDataReader.ReadAsync
				//new Assertions.ExpectedMetric { metricName = @"DotNet/DatabaseResult/Iterate", callCount = 3 },
				//new Assertions.ExpectedMetric { metricName = @"DotNet/DatabaseResult/Iterate", callCount = 3, metricScope = "WebTransaction/MVC/DefaultController/PostgresAsync"}
			};
            var unexpectedMetrics = new List<Assertions.ExpectedMetric>
            {
				...
				new Assertions.ExpectedMetric { metricName = @"Datastore/operation/Postgres/select", callCount = 1, metricScope = "WebTransaction/MVC/DefaultController/PostgresAsync" }
            };
            ...
            var expectedSqlTraces = new List<Assertions.ExpectedSqlTrace>
            {
                ...
                {
                    TransactionName = "WebTransaction/MVC/DefaultController/PostgresAsync",
            ...
            var transactionSample = _fixture.AgentLog.TryGetTransactionSample("WebTransaction/MVC/DefaultController/PostgresAsync");
            var transactionEvent = _fixture.AgentLog.TryGetTransactionEvent("WebTransaction/MVC/DefaultController/PostgresAsync");
