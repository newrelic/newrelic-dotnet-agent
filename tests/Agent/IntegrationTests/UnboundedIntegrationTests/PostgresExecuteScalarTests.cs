...
namespace NewRelic.Agent.UnboundedIntegrationTests
{
    ...
    public class PostgresExecuteScalarTests : IClassFixture<PostgresBasicMvcFixture>
    {
        ...
        public void Test()
        {
            var expectedSyncTransactionName = "WebTransaction/MVC/PostgresController/PostgresExecuteScalar";
            var expectedAsyncTransactionName = "WebTransaction/MVC/PostgresController/PostgresExecuteScalarAsync";
            ...
            var expectedMetrics = new List<Assertions.ExpectedMetric>
            {
                ...
                new Assertions.ExpectedMetric { metricName = $@"Datastore/instance/Postgres/{PostgresConfiguration.PostgresServer}/{PostgresConfiguration.PostgresPort}", callCount = expectedDatastoreCallCount},
