...
{
    [NetFrameworkTest]
    public class MongoDB2_6_MongoQueryProviderTests : NewRelicIntegrationTest<RemoteServiceFixtures.MongoDB2_6FrameworkApplicationFixture>
    {
        ...
        public MongoDB2_6_MongoQueryProviderTests(RemoteServiceFixtures.MongoDB2_6FrameworkApplicationFixture fixture, ITestOutputHelper output)  : base(fixture)
        {
            _fixture = fixture;
