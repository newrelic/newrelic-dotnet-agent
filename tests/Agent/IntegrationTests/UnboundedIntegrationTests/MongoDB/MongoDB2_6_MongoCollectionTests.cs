...
{
    [NetFrameworkTest]
    public class MongoDB2_6_MongoCollectionTests : NewRelicIntegrationTest<RemoteServiceFixtures.MongoDB2_6FrameworkApplicationFixture>
    {
        ...
        public MongoDB2_6_MongoCollectionTests(RemoteServiceFixtures.MongoDB2_6FrameworkApplicationFixture fixture, ITestOutputHelper output)  : base(fixture)
        {
            _fixture = fixture;
