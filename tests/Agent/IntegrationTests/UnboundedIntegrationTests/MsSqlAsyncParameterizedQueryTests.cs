...
{
    public class MsSqlAsyncTestsParameterizedQuery : IClassFixture<RemoteServiceFixtures.MsSqlBasicMvcFixture>
    {
        [NotNull]
        private readonly RemoteServiceFixtures.MsSqlBasicMvcFixture _fixture;

        public MsSqlAsyncTestsParameterizedQuery([NotNull] RemoteServiceFixtures.MsSqlBasicMvcFixture fixture, [NotNull] ITestOutputHelper output)
        {
            _fixture = fixture;
            ...
            (
                ...
                exerciseApplication: () =>
                {
                    _fixture.GetMsSqlAsync_WithParameterizedQuery();
                }
            );
            _fixture.Initialize();
        }
        ...
        public void Test()
        {
            var expectedMetrics = new List<Assertions.ExpectedMetric>
            {
                ...
                new Assertions.ExpectedMetric { metricName = $@"Datastore/statement/MSSQL/{_fixture.TableName}/insert", callCount = 1, metricScope = "WebTransaction/MVC/DefaultController/MsSqlAsync_WithParameterizedQuery"},
            ...
            var expectedSqlTraces = new List<Assertions.ExpectedSqlTrace>
            {
                ...
                {
                    TransactionName = "WebTransaction/MVC/DefaultController/MsSqlAsync_WithParameterizedQuery",
            ...
            var transactionSample = _fixture.AgentLog.TryGetTransactionSample("WebTransaction/MVC/DefaultController/MsSqlAsync_WithParameterizedQuery");
            var transactionEvent = _fixture.AgentLog.TryGetTransactionEvent("WebTransaction/MVC/DefaultController/MsSqlAsync_WithParameterizedQuery");
