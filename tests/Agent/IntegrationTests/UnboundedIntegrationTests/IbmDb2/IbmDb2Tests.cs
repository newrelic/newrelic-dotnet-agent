...
//                new Assertions.ExpectedMetric { metricName = $@"Datastore/statement/IBMDB2/{_fixture.TableName}/select", callCount = 1, metricScope = "WebTransaction/MVC/IbmDb2Controller/InvokeIbmDb2Query"},
...
//                new Assertions.ExpectedMetric { metricName = $@"Datastore/statement/IBMDB2/{_fixture.TableName}/insert", callCount = 1, metricScope = "WebTransaction/MVC/IbmDb2Controller/InvokeIbmDb2Query"},
...
//                new Assertions.ExpectedMetric { metricName = $@"Datastore/statement/IBMDB2/{_fixture.TableName}/delete", callCount = 1, metricScope = "WebTransaction/MVC/IbmDb2Controller/InvokeIbmDb2Query"},

//                new Assertions.ExpectedMetric { metricName = @"DotNet/DatabaseResult/Iterate", callCount = expectedIterateCallCount },
//                new Assertions.ExpectedMetric { metricName = @"DotNet/DatabaseResult/Iterate", callCount = expectedIterateCallCount,  metricScope = "WebTransaction/MVC/IbmDb2Controller/InvokeIbmDb2Query"}
//            };
...
//                new Assertions.ExpectedMetric { metricName = @"Datastore/operation/IBMDB2/select", metricScope = "WebTransaction/MVC/IbmDb2Controller/InvokeIbmDb2Query" },
//                new Assertions.ExpectedMetric { metricName = @"Datastore/operation/IBMDB2/insert", metricScope = "WebTransaction/MVC/IbmDb2Controller/InvokeIbmDb2Query" },
//                new Assertions.ExpectedMetric { metricName = @"Datastore/operation/IBMDB2/delete", metricScope = "WebTransaction/MVC/IbmDb2Controller/InvokeIbmDb2Query" }
//            };
...
//                {
//                    TransactionName = "WebTransaction/MVC/IbmDb2Controller/InvokeIbmDb2Query",
...
//            var transactionSample = _fixture.AgentLog.TryGetTransactionSample("WebTransaction/MVC/IbmDb2Controller/InvokeIbmDb2Query");
//            var transactionEvent = _fixture.AgentLog.TryGetTransactionEvent("WebTransaction/MVC/IbmDb2Controller/InvokeIbmDb2Query");
