...
{
    [NetFrameworkTest]
    public class WebApi2CodeAttributesTest : NewRelicIntegrationTest<WebApiAsyncFixture>
    {
        ...
        public WebApi2CodeAttributesTest(WebApiAsyncFixture fixture, ITestOutputHelper output) : base(fixture)
        {
            _fixture = fixture;
