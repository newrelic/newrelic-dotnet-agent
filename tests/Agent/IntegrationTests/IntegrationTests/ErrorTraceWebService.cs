    ...
    public class ErrorTraceWebService : IClassFixture<RemoteServiceFixtures.BasicWebService>
    {
        ...
        public void Test()
        {
            ...
            NrAssert.Multiple(
                ...
                () => Assert.Equal("System.Reflection.TargetInvocationException", errorTraces[0].ExceptionClassName),
                ...
                () => Assert.Equal("System.Reflection.TargetInvocationException", errorTraces[1].ExceptionClassName),
