        ...
        public OtherTransaction([NotNull] RemoteServiceFixtures.AgentApiExecutor fixture, [NotNull] ITestOutputHelper output)
        {
            ...
            (
                setupConfiguration: () =>
                {
                    ...
                    CommonUtils.AddCustomInstrumentation(instrumentationFilePath, "NewRelic.Agent.IntegrationTests.Applications.AgentApiExecutor", "NewRelic.Agent.IntegrationTests.Applications.AgentApiExecutor.Program", "RealMain", "NewRelic.Providers.Wrapper.CustomInstrumentation.OtherTransactionWrapper", "MyCustomMetricName", 7);
