...
public static class RuntimeTraitPolicy
{
    ...
    private static readonly string[] Exempt =
    {
        ...
        "NewRelic.Agent.IntegrationTests.TestInfrastructure.RuntimeTraitCompletenessTests",
        "NewRelic.Agent.IntegrationTests.TestInfrastructure.RuntimeTraitAgreementTests",
    };
