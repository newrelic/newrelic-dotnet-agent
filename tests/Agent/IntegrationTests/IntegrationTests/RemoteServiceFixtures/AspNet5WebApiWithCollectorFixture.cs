...
namespace NewRelic.Agent.IntegrationTests.RemoteServiceFixtures
{
    ...
    {
        public AspNet5WebApiWithCollectorFixture() : base(new RemoteService("AspNet5BasicWebApiApplication", "AspNet5BasicWebApiApplication.exe", "net5.0", ApplicationType.Bounded, true, true, true))
        {
        }
