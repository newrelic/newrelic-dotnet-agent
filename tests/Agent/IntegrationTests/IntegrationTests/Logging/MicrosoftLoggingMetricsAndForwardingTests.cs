...
{
    public abstract class MicrosoftLoggingMetricsAndForwardingTestsBase<TFixture> : NewRelicIntegrationTest<TFixture>
        where TFixture : ConsoleDynamicMethodFixture
    {
        ...
        public MicrosoftLoggingMetricsAndForwardingTestsBase(TFixture fixture, ITestOutputHelper output, bool metricsEnabled, bool forwardingEnabled) : base(fixture)
        {
            _fixture = fixture;
        ...
        {
            var actualMetrics = _fixture.AgentLog.GetMetrics();
            Assert.Contains(actualMetrics, x => x.MetricSpec.Name == "Supportability/Logging/DotNET/MicrosoftLogging/enabled");
        }
        ...
        public void LoggingWorksInsideTransaction()
        {
            if (_forwardingEnabled)
            {
                ...
                new Assertions.ExpectedLogLine { LogLevel = "TRACE", LogMessage = InTransactionFatalMessage, HasTraceId = true, HasSpanId = true },
                };
        ...
        public void AsyncLoggingWorksInsideTransaction()
        {
            if (_forwardingEnabled)
            {
                ...
                new Assertions.ExpectedLogLine { LogLevel = "TRACE", LogMessage = AsyncInTransactionFatalMessage, HasTraceId = true, HasSpanId = true },
                };
        ...
        public void AsyncNoAwaitLoggingWorksInsideTransaction()
        {
            if (_forwardingEnabled)
            {
                ...
                new Assertions.ExpectedLogLine { LogLevel = "TRACE", LogMessage = AsyncNoAwaitInTransactionFatalMessage},
                };
        ...
        public void LoggingWorksOutsideTransaction()
        {
            if (_forwardingEnabled)
            {
                ...
                new Assertions.ExpectedLogLine { LogLevel = "TRACE", LogMessage = OutsideTransactionFatalMessage, HasSpanId = false, HasTraceId = false},
                };
        ...
        public void AsyncLoggingWorksOutsideTransaction()
        {
            if (_forwardingEnabled)
            {
                ...
                new Assertions.ExpectedLogLine { LogLevel = "TRACE", LogMessage = AsyncOutsideTransactionFatalMessage, HasSpanId = false, HasTraceId = false},
                };
        ...
        public void AsyncNoAwaitLoggingWorksOutsideTransaction()
        {
            if (_forwardingEnabled)
            {
                ...
                new Assertions.ExpectedLogLine { LogLevel = "TRACE", LogMessage = AsyncNoAwaitOutsideTransactionFatalMessage, HasSpanId = false, HasTraceId = false},
                };
        ...
        public void AsyncNoAwaitWithDelayLoggingWorksInsideTransaction()
        {
            if (_forwardingEnabled)
            {
                ...
                new Assertions.ExpectedLogLine { LogLevel = "TRACE", LogMessage = AsyncNoAwaitWithDelayInTransactionFatalMessage, HasTraceId = true, HasSpanId = true },
                };
    ...
    [NetCoreTest]
    public class MicrosoftLoggingMetricsAndForwardingEnabledTestsNetCoreLatestTests : MicrosoftLoggingMetricsAndForwardingTestsBase<ConsoleDynamicMethodFixtureCoreLatest>
    {
    ...
    [NetCoreTest]
    public class MicrosoftLoggingMetricsAndForwardingEnabledTestsNetCore50Tests : MicrosoftLoggingMetricsAndForwardingTestsBase<ConsoleDynamicMethodFixtureCore50>
    {
    ...
    [NetCoreTest]
    public class MicrosoftLoggingMetricsAndForwardingEnabledTestsNetCore31Tests : MicrosoftLoggingMetricsAndForwardingTestsBase<ConsoleDynamicMethodFixtureCore31>
    {
    ...
    [NetCoreTest]
    public class MicrosoftLoggingMetricsAndForwardingEnabledTestsNetCore21Tests : MicrosoftLoggingMetricsAndForwardingTestsBase<ConsoleDynamicMethodFixtureCore21>
    {
    ...
    [NetCoreTest]
    public class MicrosoftLoggingMetricsAndForwardingDisabledTestsNetCoreLatestTests : MicrosoftLoggingMetricsAndForwardingTestsBase<ConsoleDynamicMethodFixtureCoreLatest>
    {
    ...
    [NetCoreTest]
    public class MicrosoftLoggingMetricsAndForwardingDisabledTestsNetCore50Tests : MicrosoftLoggingMetricsAndForwardingTestsBase<ConsoleDynamicMethodFixtureCore50>
    {
    ...
    [NetCoreTest]
    public class MicrosoftLoggingMetricsAndForwardingDisabledTestsNetCore31Tests : MicrosoftLoggingMetricsAndForwardingTestsBase<ConsoleDynamicMethodFixtureCore31>
    {
    ...
    [NetCoreTest]
    public class MicrosoftLoggingMetricsAndForwardingDisabledTestsNetCore21Tests : MicrosoftLoggingMetricsAndForwardingTestsBase<ConsoleDynamicMethodFixtureCore21>
    {
    ...
    [NetCoreTest]
    public class MicrosoftLoggingMetricsEnabledAndForwardingDisabledTestsNetCoreLatestTests : MicrosoftLoggingMetricsAndForwardingTestsBase<ConsoleDynamicMethodFixtureCoreLatest>
    {
    ...
    [NetCoreTest]
    public class MicrosoftLoggingMetricsEnabledAndForwardingDisabledTestsNetCore50Tests : MicrosoftLoggingMetricsAndForwardingTestsBase<ConsoleDynamicMethodFixtureCore50>
    {
    ...
    [NetCoreTest]
    public class MicrosoftLoggingMetricsEnabledAndForwardingDisabledTestsNetCore31Tests : MicrosoftLoggingMetricsAndForwardingTestsBase<ConsoleDynamicMethodFixtureCore31>
    {
    ...
    [NetCoreTest]
    public class MicrosoftLoggingMetricsEnabledAndForwardingDisabledTestsNetCore21Tests : MicrosoftLoggingMetricsAndForwardingTestsBase<ConsoleDynamicMethodFixtureCore21>
    {
    ...
    [NetCoreTest]
    public class MicrosoftLoggingMetricsDisabledAndForwardingEnabledTestsNetCoreLatestTests : MicrosoftLoggingMetricsAndForwardingTestsBase<ConsoleDynamicMethodFixtureCoreLatest>
    {
    ...
    [NetCoreTest]
    public class MicrosoftLoggingMetricsDisabledAndForwardingEnabledTestsNetCore50Tests : MicrosoftLoggingMetricsAndForwardingTestsBase<ConsoleDynamicMethodFixtureCore50>
    {
    ...
    [NetCoreTest]
    public class MicrosoftLoggingMetricsDisabledAndForwardingEnabledTestsNetCore31Tests : MicrosoftLoggingMetricsAndForwardingTestsBase<ConsoleDynamicMethodFixtureCore31>
    {
    ...
    [NetCoreTest]
    public class MicrosoftLoggingMetricsDisabledAndForwardingEnabledTestsNetCore22Tests : MicrosoftLoggingMetricsAndForwardingTestsBase<ConsoleDynamicMethodFixtureCore22>
    {
    ...
    [NetCoreTest]
    public class MicrosoftLoggingMetricsDisabledAndForwardingEnabledTestsNetCore21Tests : MicrosoftLoggingMetricsAndForwardingTestsBase<ConsoleDynamicMethodFixtureCore21>
    {
