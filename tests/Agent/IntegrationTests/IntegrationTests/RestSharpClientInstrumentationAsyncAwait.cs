...
{
    public class RestSharpInstrumentationAsyncAwait : IClassFixture<RemoteServiceFixtures.BasicMvcApplication>
    {
        [NotNull]
        private readonly RemoteServiceFixtures.BasicMvcApplication _fixture;

        public RestSharpInstrumentationAsyncAwait([NotNull] RemoteServiceFixtures.BasicMvcApplication fixture, [NotNull] ITestOutputHelper output)
        {
            _fixture = fixture;
        ...
        public void Test()
        {
            ...
            var expectedMetrics = new List<Assertions.ExpectedMetric>
            {
                ...
                new Assertions.ExpectedMetric { metricName = $"ExternalTransaction/{myHostname}/{expectedCrossProcessId}/WebTransaction/WebAPI/RestAPI/Get", metricScope = @"WebTransaction/MVC/RestSharpController/AsyncAwaitClient", callCount = 1 },
                new Assertions.ExpectedMetric { metricName = $"ExternalTransaction/{myHostname}/{expectedCrossProcessId}/WebTransaction/WebAPI/RestAPI/Put", metricScope = @"WebTransaction/MVC/RestSharpController/AsyncAwaitClient", callCount = 1 },
                new Assertions.ExpectedMetric { metricName = $"ExternalTransaction/{myHostname}/{expectedCrossProcessId}/WebTransaction/WebAPI/RestAPI/Post", metricScope = @"WebTransaction/MVC/RestSharpController/AsyncAwaitClient", callCount = 1 },
                new Assertions.ExpectedMetric { metricName = $"ExternalTransaction/{myHostname}/{expectedCrossProcessId}/WebTransaction/WebAPI/RestAPI/Delete", metricScope = @"WebTransaction/MVC/RestSharpController/AsyncAwaitClient", callCount = 1 },
            };
