    ...
    public class CatEnabledChainedRequests : IClassFixture<RemoteServiceFixtures.BasicMvcApplication>
    {
        ...
        public void Test()
        {
            ...
            var expectedMetrics = new List<Assertions.ExpectedMetric>
            {
                ...
                new Assertions.ExpectedMetric { metricName = $@"ExternalTransaction/{_fixture.RemoteApplication.DestinationServerName}/{expectedCrossProcessId}/WebTransaction/MVC/DefaultController/Index", metricScope = @"WebTransaction/MVC/DefaultController/Chained", callCount = 1 },
