...
public class CatEnabledChainedRequestsWebRequest : NewRelicIntegrationTest<RemoteServiceFixtures.BasicMvcApplicationTestFixture>
{
    ...
    public void Test()
    {
        ...
        var expectedMetrics = new List<Assertions.ExpectedMetric>
        {
            ...
            new Assertions.ExpectedMetric { metricName = $@"External/{RemoteApplication.DestinationServerName}/all", CallCountAllHarvests = 1 },
            new Assertions.ExpectedMetric { metricName = $@"ExternalApp/{RemoteApplication.DestinationServerName}/{crossProcessId}/all", CallCountAllHarvests = 1 },
            new Assertions.ExpectedMetric { metricName = $@"ExternalTransaction/{RemoteApplication.DestinationServerName}/{crossProcessId}/WebTransaction/MVC/DefaultController/Index", CallCountAllHarvests = 1 },
            new Assertions.ExpectedMetric { metricName = $@"ExternalTransaction/{RemoteApplication.DestinationServerName}/{crossProcessId}/WebTransaction/MVC/DefaultController/Index", metricScope = @"WebTransaction/MVC/DefaultController/ChainedWebRequest", CallCountAllHarvests = 1 },
            new Assertions.ExpectedMetric { metricName = $@"External/{RemoteApplication.DestinationServerName}/Stream/GET", CallCountAllHarvests = 1 },
