...
{
	public class CatEnabledChainedAsyncAwaitRestSharp : IClassFixture<RemoteServiceFixtures.BasicMvcApplication>
	{
		[NotNull]
		...
		public CatEnabledChainedAsyncAwaitRestSharp([NotNull] RemoteServiceFixtures.BasicMvcApplication fixture, [NotNull] ITestOutputHelper output)
		{
			_fixture = fixture;
			...
			_fixture.Actions(
				...
				{
					_fixture.GetIgnored();
					_responseHeaders = _fixture.GetRestSharpAsyncAwaitClientWithHeaders(method: "GET", generic: true, cancelable: true);
				}
			);
			_fixture.Initialize();
		}
		...
		public void Test()
		{
			...
			var calleeTransactionEvent = _fixture.AgentLog.TryGetTransactionEvent("WebTransaction/MVC/RestSharpController/AsyncAwaitClient");
			...
			var expectedMetrics = new List<Assertions.ExpectedMetric>
			{
				...
				new Assertions.ExpectedMetric { metricName = $@"ExternalApp/{myHostname}/{expectedCrossProcessId}/all", callCount = 1 },
				new Assertions.ExpectedMetric { metricName = $@"ExternalTransaction/{myHostname}/{expectedCrossProcessId}/WebTransaction/WebAPI/RestAPI/Get", callCount = 1 },
			...
			NrAssert.Multiple(
				() => Assert.Equal(expectedCrossProcessId, catResponseData.CrossProcessId),
				() => Assert.Equal("WebTransaction/MVC/RestSharpController/AsyncAwaitClient", catResponseData.TransactionName),
