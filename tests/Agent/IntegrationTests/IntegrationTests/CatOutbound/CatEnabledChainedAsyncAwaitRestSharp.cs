...
public class CatEnabledChainedAsyncAwaitRestSharp : NewRelicIntegrationTest<RemoteServiceFixtures.BasicMvcApplicationTestFixture>
{
    ...
    public void Test()
    {
        ...
        var expectedMetrics = new List<Assertions.ExpectedMetric>
        {
            ...
            new Assertions.ExpectedMetric { metricName = $@"External/{myHostname}/all", CallCountAllHarvests = 1 },
            new Assertions.ExpectedMetric { metricName = $@"ExternalApp/{myHostname}/{crossProcessId}/all", CallCountAllHarvests = 1 },
            new Assertions.ExpectedMetric { metricName = $@"ExternalTransaction/{myHostname}/{crossProcessId}/WebTransaction/WebAPI/RestAPI/Get", CallCountAllHarvests = 1 },
            new Assertions.ExpectedMetric { metricName = $@"ExternalTransaction/{myHostname}/{crossProcessId}/WebTransaction/WebAPI/RestAPI/Get", metricScope = @"WebTransaction/MVC/RestSharpController/AsyncAwaitClient", CallCountAllHarvests = 1 },
            new Assertions.ExpectedMetric { metricName = $@"External/{myHostname}/Stream/GET", CallCountAllHarvests = 1 },
