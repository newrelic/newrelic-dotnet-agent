...
[Trait("Architecture", "amd64")]
[Trait("Distro", "Ubuntu")]
public class KafkaDotNet11Test : LinuxKafkaTest<KafkaDotNet11TestFixture>
{
    public KafkaDotNet11Test(KafkaDotNet11TestFixture fixture, ITestOutputHelper output) : base(fixture, output)
    {
    }
}
