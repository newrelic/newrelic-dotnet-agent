...
namespace NewRelic.Installer
{
    public class Program
    {
        ...
        private string DestinationHomeDirectoryPath { get { return Path.Combine(SolutionPath, "Agent", DestinationHomeDirectoryName); } }
        ...
        private string DestinationRegistryFilePath { get { return Path.Combine(SolutionPath, "Agent", DestinationRegistryFileName); } }
        ...
        private string NewRelicAgentCoreCsprojPath { get { return Path.Combine(SolutionPath, "src", "Agent", "NewRelic", "Agent", "Core", "Core.csproj"); } }
        ...
        private string MiscInstrumentationFilePath => Path.Combine(SolutionPath, "src", "Agent", "Miscellaneous", "NewRelic.Providers.Wrapper.Misc.Instrumentation.xml");
        ...
        private string ProfilerDllPath
        {
            get
            {
                var profilerPath = Path.Combine(SolutionPath, "src", "Agent", "_profilerBuild", $"{Bitness}-Release", "NewRelic.Profiler.dll");
                return profilerPath;
            }
        }
        ...
        private string ProfilerSoPath
        {
            get
            {
                var profilerPath = Path.Combine(SolutionPath, "src", "Agent", "_profilerBuild", "linux-release", ProfilerSoFileName);
                return profilerPath;
            }
        }
