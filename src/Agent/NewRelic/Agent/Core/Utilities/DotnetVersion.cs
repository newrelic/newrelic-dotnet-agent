...
namespace NewRelic.Agent.Core.Utilities
{
    ...
    public static class DotnetVersion
    {
        ...
        public static bool IsUnsupportedDotnetCoreVersion(DotnetCoreVersion version)
        {
            ...
            // is smaller.
            var supportedDotnetCoreVersions = new List<DotnetCoreVersion> { DotnetCoreVersion.net8, DotnetCoreVersion.net9, DotnetCoreVersion.net10, DotnetCoreVersion.Other };
