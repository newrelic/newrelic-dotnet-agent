...
namespace NewRelic.Agent.Core.Configuration
{
    ...
    public class DefaultConfiguration : IConfiguration
    {
        ...
        public bool HybridHttpContextStorageEnabled => EnvironmentOverrides(TryGetAppSettingAsBoolWithDefault("HybridHttpContextStorageEnabled", true), "NEW_RELIC_HTTP_CONTEXT_STORAGE_ENABLED");
