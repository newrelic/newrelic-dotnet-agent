    ...
    : ExternalSegmentData(uri, method, "gRPC", crossApplicationResponseData)
{
    ...
    public override void SetSpanTypeSpecificAttributes(SpanAttributeValueCollection attribVals)
    {
        ...
        AttribDefs.Procedure.TrySetValue(attribVals, Method); // TODO Otel spec says this is the correct "method" attribute
...
public class ExternalSegmentData(Uri uri, string method, string library = "Stream", CrossApplicationResponseData crossApplicationResponseData = null, string componentOverride = null)
    : AbstractSegmentData, IExternalSegmentData
{
