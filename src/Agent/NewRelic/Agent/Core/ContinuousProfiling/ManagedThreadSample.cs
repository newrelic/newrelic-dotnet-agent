...
public class ManagedThreadSample
{
    ...
    public ManagedThreadSample(string threadName, long osThreadId, long traceIdHigh, long traceIdLow, long spanId, IReadOnlyList<string> frames, bool isAgentWork = false)
    {
