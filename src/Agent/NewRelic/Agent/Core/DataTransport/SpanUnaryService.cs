...
public class SpanUnaryService : UnaryDataService<Span, SpanBatch, RecordStatus>
{
    public SpanUnaryService(IGrpcUnaryWrapper<SpanBatch, RecordStatus> grpcWrapper, IDelayer delayer, IConfigurationService configSvc, IAgentHealthReporter agentHealthReporter, IAgentTimerService agentTimerService, IEnvironment environment)
