...
namespace NewRelic.Agent.Core.DataTransport
{
    ...
    public class ConnectionHandler : ConfigurationBasedService, IConnectionHandler
    {
        ...
        public async Task ConnectAsync()
        {
            ...
            try
            {
                ...
                if (_configuration.SecurityPoliciesTokenExists)
                {
                    ...
                    EventBus<SecurityPoliciesConfigurationUpdatedEvent>.PublishAsync(new SecurityPoliciesConfigurationUpdatedEvent(securityPoliciesConfiguration));
        ...
        private ServerConfiguration SendConnectRequest()
        {
            ...
            var responseMap = SendNonDataRequestAsync<Dictionary<string, object>>("connect", connectParameters);
            if (responseMap == null)
        ...
        private void Disable()
        {
            ...
            EventBus<ServerConfigurationUpdatedEvent>.PublishAsync(new ServerConfigurationUpdatedEvent(ServerConfiguration.GetDefault()));
        }
