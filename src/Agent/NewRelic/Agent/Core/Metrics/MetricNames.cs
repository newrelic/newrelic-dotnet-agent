...
namespace NewRelic.Agent.Core.Metrics
{
    ...
    public static class MetricNames
    {
        ...
        public const string SupportabilitySpanEventLinksDropped = SpanEventsPs + "Links" + PathSeparator + "Dropped";
        public const string SupportabilitySpanEventEventsDropped = SpanEventsPs + "Events" + PathSeparator + "Dropped";
