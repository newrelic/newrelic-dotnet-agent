...
namespace NewRelic.Agent.Core
{
    public sealed class AgentManager : IAgentManager, IDisposable
    {
        ...
        private AgentManager()
        {
            ...
            AgentServices.RegisterServices(_container, bootstrapConfig.ServerlessModeEnabled, bootstrapConfig.ModernGCSamplerEnabled);
            ...
            AgentServices.StartServices(_container, bootstrapConfig.ServerlessModeEnabled, bootstrapConfig.ModernGCSamplerEnabled);
...
#if NETFRAMEWORK
            if (DotnetVersion.IsUnsupportedDotnetFrameworkVersion(AgentInstallConfiguration.DotnetFrameworkVersion))
            {
