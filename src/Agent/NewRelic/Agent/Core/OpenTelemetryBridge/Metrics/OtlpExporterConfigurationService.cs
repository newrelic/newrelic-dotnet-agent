...
public class OtlpExporterConfigurationService : DisposableService, IOtlpExporterConfigurationService
{
    ...
    private void RecreateMeterProviderInternal()
    {
        ...
        var providerBuilder = Sdk.CreateMeterProviderBuilder()
            ...
            .AddOtlpExporter((exporterOptions, metricReaderOptions) =>
            {
                ...
                metricReaderOptions.PeriodicExportingMetricReaderOptions.ExportIntervalMilliseconds = config.OpenTelemetryMetricsExportInterval;
                metricReaderOptions.PeriodicExportingMetricReaderOptions.ExportTimeoutMilliseconds = config.OpenTelemetryMetricsExportTimeout;
    ...
    private HttpClient CreateHttpClientWithProxyAndRetry(IConnectionInfo connectionInfo)
    {
        try
        {
            ...
            httpClient.Timeout = TimeSpan.FromMilliseconds(_configurationService.Configuration.OpenTelemetryMetricsExportTimeout);
