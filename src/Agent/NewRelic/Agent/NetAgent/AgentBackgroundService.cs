...
namespace NewRelic.Agent.NetAgent;

public class AgentBackgroundService : BackgroundService
{
    private IContainer _container;
    private ConfigurationSubscriber _configurationSubscription = new ConfigurationSubscriber();
    ...
    //private bool _shutdownEventReceived;
