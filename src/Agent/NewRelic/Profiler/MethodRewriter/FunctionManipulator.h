...
//#define TEST_UNSAFE 1
    ...
    protected:
        ...
        {
            // System.Console is not available in System.Private.CoreLib; it is defined in System.Console
            // which is not already a reference in all assemblies. Allow this DEBUG build only writing
            // in .NET Framework apps.
            if (!_isCoreClr)
            {
