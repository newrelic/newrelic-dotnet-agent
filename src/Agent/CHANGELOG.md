...
Enables nullable reference types that are part of the C# 9.0 language specification.  There should be no required changes in API usage.
...
[Unreleased]: https://github.com/newrelic/newrelic-dotnet-agent/compare/v8.31.0...HEAD
