...
* Fixes issue in .NET 5 applications where external calls made with HttpClient may not get instrumented. For example, calls made with HttpClient.GetStringAsync would be missed. ([#235](https://github.com/newrelic/newrelic-dotnet-agent/issues/225))
